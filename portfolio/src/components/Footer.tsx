...
export default function FooterComponent() {
    ...
    return(
        <div className="container mx-auto h-28 flex flex-col md:flex-row justify-center items-center md:justify-between px-10 text-sm font-semibold text-slate-800">
